...
<body>
	<div class="center">
		...
		<div class="main">
			<div class="pageTitle">密码锁仓库管理—锁种类</div>
		...
		增加：<br />
			种类名称：<s:textfield id="kindName" name="kindOfKey.kindName"
						...
						<br />
			添加备注：<s:textfield id="remark" name="kindOfKey.remark" maxLength="85"
							cssClass="remark"></s:textfield>
					...
					<table class="table">
						<thead>
							<th width="70"><input class="select-all" name=""
								...
								href="javascript:del('kindOfKey_removeAll')">删除</a>
							</th>
							<th width="">密码锁名称</th>
							<th width="">新建人</th>
							<th width="50%">备注</th>
						...
						<tbody>
							...
							<tr>
								<td colspan="5" class="pageControl"><%@ include
